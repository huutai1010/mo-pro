...
class JourneyHasGoneView extends StatefulWidget {
  const JourneyHasGoneView({super.key});

  @override
  State<JourneyHasGoneView> createState() => _JourneyHasGoneViewState();
}

class _JourneyHasGoneViewState extends State<JourneyHasGoneView> {
  ...
  @override
  void initState() {
    journeysData = journeyViewModel.getJourneyByStatus(2);
    ...
    return GestureDetector(
      onTap: () async {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => TourTrackingViewV2(
              canDisplayVoice: true,
